...
$jumlah  = mysqli_query($koneksi, "SELECT total_cases FROM covid_data");
...
<body>
    <center><h2>GRAFIK DOUGHNUT "TOTAL CASES" COVID-19</h2></center>
...
var data = {
            ...
            datasets: [
            {
            data: [<?php while ($p = mysqli_fetch_array($jumlah)) { echo '"' . $p['total_cases'] . '",';}?>],
            backgroundColor: [
					'rgba(255, 99, 132, 0.2)',
					'rgba(255, 159, 64, 0.2)',
					'rgba(234, 214, 77, 0.2)',
